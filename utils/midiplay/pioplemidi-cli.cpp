 ...
 *
 * This version has been modified by mueller_minki (aka iAmInActions)
 * to run better on the Raspberry Pi SBC. Please do not contact the
 * original creator if issues with this version appear.
 *
 */
...
int main(int argc, char **argv)
{
    ...
    {
        std::printf(
            "Usage: pioplemidi <midifilename> [ <options> ] \n"
